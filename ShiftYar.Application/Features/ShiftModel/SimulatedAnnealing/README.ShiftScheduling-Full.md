...
- **محدودیت‌ها**: تعداد نیرو بر حسب تخصص، تعادل جنسیتی، حداکثر نوبت‌های متوالی، حداقل استراحت، حداکثر شیفت هفتگی/شبانه، سقف موظفی بهره‌وری، اولویت پر کردن موظفی (غیرطرحی قبل از طرحی)، OFF تأییدشده → شب روز قبل مسدود، سهمیه‌های روزانه ماهانه و قانون تناوب هفتگی شیفت‌های روزانه (صبح ↔ عصر با استثنای شیفت شب)، و ...
- **ترجیحات**: تاریخ‌های عدم حضور، شیفت‌های ترجیحی/ناخواسته؛ درخواست‌های تأییدشده (`Approved`) به‌صورت سخت اعمال می‌شوند و بر قانون تناوب هفتگی و مجوزهای نوع شیفت ارجحیت مطلق دارند.
