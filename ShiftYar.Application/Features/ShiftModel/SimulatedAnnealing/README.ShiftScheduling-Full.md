...
- **محدودیت‌ها**: تعداد نیرو بر حسب تخصص، تعادل جنسیتی، حداکثر نوبت‌های متوالی، حداقل استراحت، حداکثر شیفت هفتگی/شبانه، سقف موظفی بهره‌وری، اولویت پر کردن موظفی (غیرطرحی قبل از طرحی)، OFF تأییدشده → شب روز قبل مسدود، و ...
- **ترجیحات**: تاریخ‌های عدم حضور، شیفت‌های ترجیحی/ناخواسته؛ درخواست‌های تأییدشده (`Approved`) به‌صورت سخت اعمال می‌شوند.
