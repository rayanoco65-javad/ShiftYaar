...
### فعال‌سازی
- `EnableOvertimeDistributionBySeniority`: فعال/غیرفعال کردن توزیع اضافه کار بر اساس سابقه
...
- `OvertimePreferenceType`: نوع ترجیح اضافه کار در دپارتمان
  ...
  - `1`: **گریزان از اضافه کار** - شیفت‌های مازاد بر موظفی به پرسنل با سابقه کمتر اختصاص می‌یابد تا پرسنل با سابقه بالاتر در حد موظفی محافظت شوند.
