...
{
    /// <inheritdoc />
    public partial class _140505132 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //        AllowCurrentMonthScheduling = table.Column<bool>(type: "bit", nullable: true),
            //        AllowMonthlyRescheduleWithAutoDelete = table.Column<bool>(type: "bit", nullable: true),
            //        AllowEveningAfterNightShift = table.Column<bool>(type: "bit", nullable: true),
            //        CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            //        UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            //        TheUserId = table.Column<int>(type: "int", nullable: true)
            //    },
            ...
            //        HolidayRequiredTottalCount = table.Column<int>(type: "int", nullable: true),
            //        HolidayOnCallMaleCount = table.Column<int>(type: "int", nullable: true),
            //        HolidayOnCallFemaleCount = table.Column<int>(type: "int", nullable: true),
            //        HolidayOnCallTottalCount = table.Column<int>(type: "int", nullable: true),
            //        CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            //        UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            //        TheUserId = table.Column<int>(type: "int", nullable: true)
            //    },
            ...
            //        HardshipPercent = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            //        OvertimeConsent = table.Column<bool>(type: "bit", nullable: true),
            ...
            //        ExactNightShiftCount = table.Column<int>(type: "int", nullable: true),
            //        ExactHolidayWeekendNightShiftCount = table.Column<int>(type: "int", nullable: true),
            //        CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            //        UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            //        TheUserId = table.Column<int>(type: "int", nullable: true)
            //    },
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_UserMonthlyNightQuotas", x => x.Id);
            //        table.ForeignKey(
            //            name: "FK_UserMonthlyNightQuotas_Users_UserId",
            //            column: x => x.UserId,
            //            principalTable: "Users",
            //            principalColumn: "Id",
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_UserMonthlyNightQuotas_UserId_PersianYear_PersianMonth",
            //    table: "UserMonthlyNightQuotas",
            //    columns: new[] { "UserId", "PersianYear", "PersianMonth" },
            //    unique: true);
