...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftYar.Domain.Entities.DepartmentModel.DepartmentSchedulingSettings", b =>
                {
                    ...
                    b.Property<bool>("AllowNightShiftAfterNightShift")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("EnableOvertimeDistributionBySeniority")
                        .HasColumnType("bit");

                    b.Property<int?>("OvertimePreferenceType")
                        .HasColumnType("int");

                    b.Property<double?>("OvertimeDistributionWeight")
                        .HasColumnType("float");

                    b.Property<double?>("OvertimeSeniorityDistributionSlope")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ShiftYar.Domain.Entities.UserModel.UserMonthlyComboShiftQuota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("MorningEveningFallbackParticipation")
                        .HasColumnType("bit");

                    b.Property<int?>("MorningEveningHolidayCount")
                        .HasColumnType("int");

                    b.Property<bool?>("MorningEveningHolidayFallback")
                        .HasColumnType("bit");

                    b.Property<int?>("MorningEveningShiftCount")
                        .HasColumnType("int");

                    b.Property<bool?>("MorningNightFallbackParticipation")
                        .HasColumnType("bit");

                    b.Property<int?>("MorningNightHolidayCount")
                        .HasColumnType("int");

                    b.Property<bool?>("MorningNightHolidayFallback")
                        .HasColumnType("bit");

                    b.Property<int?>("MorningNightShiftCount")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserMonthlyComboShiftQuotas");
                });
            ...
            modelBuilder.Entity("ShiftYar.Domain.Entities.UserModel.UserMonthlyComboShiftQuota", b =>
                {
                    b.HasOne("ShiftYar.Domain.Entities.UserModel.User", "User")
                        .WithMany("MonthlyComboShiftQuotas")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("ShiftYar.Domain.Entities.UserModel.User", b =>
                {
                    ...
                    b.Navigation("MonthlyComboShiftQuotas");
