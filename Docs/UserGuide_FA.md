...
- **توزیع هوشمند اضافه‌کار بر اساس سابقه خدمت (سنوات) و تمایل دپارتمان (`OvertimePreferenceType`):** در صورتی که `EnableOvertimeDistributionBySeniority = true` باشد:
  ...
  - **دپارتمان‌های گریزان از اضافه‌کار (`OvertimeAvoiding = 1`):** پرسنل با سابقه خدمت کمتر، شیفت‌های مازاد را پوشش می‌دهند تا پرسنل باسابقه در سقف موظفی قانونی باقی بمانند ($Overtime \propto \frac{1}{Seniority}$).
