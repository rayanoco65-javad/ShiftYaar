...
4. **محاسبه ساعات موظفی:** برای هر ماه، سرویس Productivity را صدا بزنید:
   ```csharp
   ...
   ```
5. **درخواست‌های شیفت:** ثبت و تأیید (حضور فقط شیفت‌مشخص؛ شب داخل سهمیه؛ حضور کل‌روز ممنوع).
6. **ارسال درخواست زمان‌بندی:** `optimize-and-save` با دپارتمان، بازه یک ماه شمسی و الگوریتم؛ سهمیه شب اجباری است.
7. **بازبینی:** در صورت نیاز حذف ماهانه (`DeleteMonthlySchedule`) و اجرای مجدد.
