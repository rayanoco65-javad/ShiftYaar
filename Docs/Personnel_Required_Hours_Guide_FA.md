...
|:-----------------------:|:-------------------------:|
| کمتر از ۵ سال (۰ تا ۴ سال) | **۰ ساعت** (بدو خدمت / طرحی) |
| ۵ تا ۱۲ سال | **۱٫۰ ساعت** |
| ۱۳ تا ۱۷ سال | **۲٫۰ ساعت** |
| ۱۸ سال و بالاتر | **۳٫۰ ساعت** (سقف سابقه بالینی) |

> **قانون شمولیت سابقه:** پرسنل با سابقه بالینی کمتر از ۵ سال مشمول کسر ساعات کاری بهره‌وری نمی‌شوند و موظفی آن‌ها برابر سقف استاندارد تقویم (۱۷۶ ساعت در ماه کامل) است.

### ۳.۲. جدول کاهش بر اساس سختی کار بخش (Hardship Reduction)

تعیین سختی کار از دو طریق انجام می‌شود:
1. **بر اساس نوع بخش:**
   - **بخش‌های ویژه (ICU, CCU, دیالیز، سوختگی و روانپزشکی با `IsSpecialSection = true`):** **۲٫۰ ساعت** در هفته.
   - **بخش‌های درمانی جنرال و عادی:** **۰٫۰ ساعت** در هفته (مگر با تأیید و آورراید مستقیم کارگزینی).
2. **بر اساس درصد سختی کار (`HardshipPercent`):**
   درصد سختی کار ثبت‌شده در پرونده کاربری صرفاً در صورتی که بخش به عنوان بخش ویژه تعریف شده باشد یا کارگزینی کسر سختی را فعال کرده باشد اعمال می‌شود تا از کسر کورکورانه ساعات در بخش‌های عادی جلوگیری گردد.

### ۳.۳. جدول کاهش بر اساس الگوی نوبت‌کاری (Shift Pattern Reduction)

طبق آیین‌نامه بیمارستانی، کسر ساعت نوبت‌کاری (شیفت در گردش) به پرسنل دارای سابقه بالینی حداقل ۱۰ سال تعلق می‌گیرد:

| الگوی نوبت‌کاری (`ShiftPatternType`) | میزان کاهش در هفته (برای سابقه $\ge 10$ سال) | توضیحات |
|:------------------------------------:|:-------------------:|:---------|
| **ثابت روزکار** (`FixedDay`) | **۰٫۰ ساعت** | بدون کاهش نوبت‌کاری |
| **دو نوبته در گردش** (`TwoShiftRotating`) | **۰٫۰ ساعت** | گردش صبح/عصر یا عصر/شب |
...
- **جدول تطابق پرسنل بخش ۲ (اورژانس اطفال - شهریور ۱۴۰۵):**

| نام پرسنل | سابقه (سال) | نوع نوبت‌کاری | تخفیف هفتگی | محاسبه موظفی نهایی | ساعت محاسبه در سامانه | ساعت واقعی کارگزینی | وضعیت تطابق |
|:----------|:-----------:|:--------------:|:------------:|:-------------------:|:------------------------:|:-------------------:|:-----------:|
| **مهدی رستمی** | ۱ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **محمد یوسفی** | ۱ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **مهدی دریکوند** | ۱ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **زهرا باقری** | ۱ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **فائزه سبزواری** | ۲ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **کیمیا کاظمی** | ۲ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **فاطمه دبستانیان** | ۲ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **شکیبا موسیوند** | ۳ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **مریم کرمی** | ۴ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **مریم امیدی منش** | ۴ | ۳ نوبته | ۰ ساعت | $176 - 0$ | **۱۷۶ ساعت** | **۱۷۶ ساعت** | ✅ کاملاً منطبق |
| **فاطمه رازانی** | ۵ | ۳ نوبته | ۱ ساعت | $176 - 5$ | **۱۷۱ ساعت** | **۱۷۱ ساعت** | ✅ کاملاً منطبق |
| **فاطمه مدهنی** | ۱۰ | ۳ نوبته | ۱ ساعت | $176 - 5$ | **۱۷۱ ساعت** | **۱۷۱ ساعت** | ✅ کاملاً منطبق |
| **حدیث کاظمی** | ۱۰ | ۳ نوبته | ۲ ساعت | $176 - 8.86$ | **۱۶۷ ساعت** | **۱۶۷ ساعت** | ✅ کاملاً منطبق |
| **عاطفه رحیمی منفرد** | ۱۰ | ۳ نوبته | ۲ ساعت | $176 - 8.86$ | **۱۶۷ ساعت** | **۱۶۷ ساعت** | ✅ کاملاً منطبق |
| **فاطمه رضایی** | ۱۱ | ۳ نوبته | ۲ ساعت | $176 - 8.86$ | **۱۶۷ ساعت** | **۱۶۷ ساعت** | ✅ کاملاً منطبق |
| **خدیجه متقی** | ۱۱ | ۳ نوبته | ۲ ساعت | $176 - 8.86$ | **۱۶۷ ساعت** | **۱۶۷ ساعت** | ✅ کاملاً منطبق |
| **فاطمه سلیمی** | ۱۳ | ۳ نوبته | ۳ ساعت | $176 - 13.29$ | **۱۶۳ ساعت** | **۱۶۳ ساعت** | ✅ کاملاً منطبق |
| **فرشته ساکی** | ۲۲ | ثابت صبح | ۳ ساعت | $176 - 13.29$ | **۱۶۳ ساعت** | **۱۶۳ ساعت** | ✅ کاملاً منطبق |
| **صبا حاتمی فیضی** | ۲۴ | ثابت صبح | ۳ ساعت | $176 - 13.29$ | **۱۶۳ ساعت** | **۱۶۳ ساعت** | ✅ کاملاً منطبق |
| **زهرا درخشانی الوار** | ۲۵ | ۲ نوبته | ۳ ساعت | $176 - 13.29$ | **۱۶۳ ساعت** | **۱۶۳ ساعت** | ✅ کاملاً منطبق |
| **بهاره بهاری پور** | ۱۸ | ۳ نوبته | ۴ ساعت | $176 - 17.71$ | **۱۵۸ ساعت** | **۱۵۸ ساعت** | ✅ کاملاً منطبق |
