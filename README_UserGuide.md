...
- درخواست شیفت (ShiftRequest): کاربر تاریخ/شیفت ترجیحی یا عدم‌حضورش را ثبت می‌کند؛ سوپروایزر پس از بررسی تأیید/رد می‌کند. فقط تأیید‌شده‌ها در برنامه لحاظ می‌شوند. سوپروایزر می‌تواند تأیید اشتباه را با رد کردن لغو کند؛ درخواست‌های ردشده قابل حذف‌اند.
